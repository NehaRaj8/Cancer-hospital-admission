...
Visualizing the trend of cancer registration for all the health board is very interesting and informative. Lots of information can be presented in a very simple way to wider audience in a very interactive way. Like the use of tooltip in scatter plot gives specific information of one date point when hovered over. The colour scheme provided by viridis package eliminates the colour blindness issue.
